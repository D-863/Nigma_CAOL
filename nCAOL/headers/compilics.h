...
#define CAOL_COMPILIFICS_COMPILER_SUBJECT() CAOL_COMPILIFICS_COMPILER_SUBJECT_DEF
#define CAOL_COMPILIFICS_COMPILER_NAME()    CAOL_COMPILIFICS_COMPILER_NAME_DEF
#define CAOL_COMPILIFICS_COMPILER_ID()      CAOL_COMPILIFICS_COMPILER_ID_DEF
