...
#define CAOL_COMPILIFICS_INTER_EXT_GET(ext, args)  CAOL_COMPILIFICS_DEF_EXTENSION_NAME_##ext##args
#define CAOL_COMPILIFICS_INTER_EXT_WRAP(ext, args) CAOL_COMPILIFICS_DEF_EXTENSION_WRAP_FUNC(CAOL_COMPILIFICS_INTER_EXT_GET(ext, args))


#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_alias(ext, target)                                   CAOL_COMPILIFICS_DEF_EXTNAME_##ext(target)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_aligned(ext, alignment)                              CAOL_COMPILIFICS_DEF_EXTNAME_##ext(alignment)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_alloc_align(ext, position)                           CAOL_COMPILIFICS_DEF_EXTNAME_##ext(position)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_alloc_size(ext, ...)                                 CAOL_COMPILIFICS_DEF_EXTNAME_##ext(__VA_ARGS__)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_always_inline(ext, ...)                              CAOL_COMPILIFICS_DEF_EXTNAME_##ext() static inline __VA_ARGS__
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_artificial(ext, ...)                                 CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_assume_aligned(ext, ...)                             CAOL_COMPILIFICS_DEF_EXTNAME_##ext(__VA_ARGS__)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_btf_decl_tag(ext, str)                               CAOL_COMPILIFICS_DEF_EXTNAME_##ext(str)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_btf_type_tag(ext, arg)                               CAOL_COMPILIFICS_DEF_EXTNAME_##ext(arg)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_cleanup(ext, func)                                   CAOL_COMPILIFICS_DEF_EXTNAME_##ext(func)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_cold(ext, ...)                                       CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_hot(ext, ...)                                        CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_common(ext, ...)                                     CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_nocommon(ext, ...)                                   CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_const(ext, ...)                                      CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_constructor(ext, priority)                           CAOL_COMPILIFICS_DEF_EXTNAME_##ext(priority)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_destructor(ext, priority)                            CAOL_COMPILIFICS_DEF_EXTNAME_##ext(priority)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_counted_by(ext, count)                               CAOL_COMPILIFICS_DEF_EXTNAME_##ext(count)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_error(ext, msg)                                      CAOL_COMPILIFICS_DEF_EXTNAME_##ext(msg)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_warning(ext, msg)                                    CAOL_COMPILIFICS_DEF_EXTNAME_##ext(msg)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_flag_enum(ext, ...)                                  CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_flatten(ext, ...)                                    CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_format(ext, archetype, string_index, first_to_check) CAOL_COMPILIFICS_DEF_EXTNAME_##ext(archetype, string_index, first_to_check)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_format_arg(ext, string_index)                        CAOL_COMPILIFICS_DEF_EXTNAME_##ext(string_index)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_gnu_inline(ext, ...)                                 CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_ifunc(ext, resolver)                                 CAOL_COMPILIFICS_DEF_EXTNAME_##ext(resolver)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_interrupt(ext, ...)                                  CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_leaf(ext, ...)                                       CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_malloc(ext, ...)                                     CAOL_COMPILIFICS_DEF_EXTNAME_##ext(__VA_ARGS__)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_may_alias(ext, ...)                                  CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_mode(ext, mode)                                      CAOL_COMPILIFICS_DEF_EXTNAME_##ext(mode)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_musttail(ext, ...)                                   CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_naked(ext, ...)                                      CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_no_profile_instrument_function(ext, ...)             CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_no_sanitize(ext, option)                             CAOL_COMPILIFICS_DEF_EXTNAME_##ext(option)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_no_sanitize_address(ext, ...)                        CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_no_address_safety_analysis(ext, ...)                 CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_no_sanitize_thread(ext, ...)                         CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_no_split_stack(ext, ...)                             CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_no_stack_protector(ext, ...)                         CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_no_stack_protector(ext, ...)                         CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_noinline(ext, ...)                                   CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_nonnull(ext, ...)                                    CAOL_COMPILIFICS_DEF_EXTNAME_##ext(__VA_ARGS__)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_nonstring(ext, ...)                                  CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_nothrow(ext, ...)                                    CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_optimize(ext, ...)                                   CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_packed(ext, ...)                                     CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_patchable_function_entry(ext, ...)                   CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_pure(ext, ...)                                       CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_retain(ext, ...)                                     CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_returns_nonnull(ext, ...)                            CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_returns_twice(ext, ...)                              CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_section(ext, section)                                CAOL_COMPILIFICS_DEF_EXTNAME_##ext(section)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_sentinel(ext, position)                              CAOL_COMPILIFICS_DEF_EXTNAME_##ext(position)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_target(ext, ...)                                     CAOL_COMPILIFICS_DEF_EXTNAME_##ext(__VA_ARGS__)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_target_version(ext, option)                          CAOL_COMPILIFICS_DEF_EXTNAME_##ext(option)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_target_clones(ext, options)                          CAOL_COMPILIFICS_DEF_EXTNAME_##ext(options)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_tls_model(ext, tls_model)                            CAOL_COMPILIFICS_DEF_EXTNAME_##ext(tls_model)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_transparent_union(ext, ...)                          CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_unavailable(ext, msg)                                CAOL_COMPILIFICS_DEF_EXTNAME_##ext(msg)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_uninitialized(ext, ...)                              CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_used(ext, ...)                                       CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_vector_size(ext, bytes)                              CAOL_COMPILIFICS_DEF_EXTNAME_##ext(bytes)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_visibility(ext, visibility_type)                     CAOL_COMPILIFICS_DEF_EXTNAME_##ext(visibility_type)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_weak(ext, ...)                                       CAOL_COMPILIFICS_DEF_EXTNAME_##ext()
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_weakref(ext, target)                                 CAOL_COMPILIFICS_DEF_EXTNAME_##ext(target)
#define CAOL_COMPILIFICS_INTER_EXTENSION_NAME_zero_call_used_regs(ext, choice)                     CAOL_COMPILIFICS_DEF_EXTNAME_##ext(choice)
